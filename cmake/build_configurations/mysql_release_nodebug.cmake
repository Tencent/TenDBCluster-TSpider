    ...
    IF(NOT IGNORE_AIO_CHECK)
      ...
      IF(NOT HAVE_LIBAIO_H OR NOT HAVE_LIBAIO)
        ...
        aio is required on Linux, you need to install the required library:
          ...
          Debian/Ubuntu:              aptet install libaio-dev
...
IF(UNIX)  
  ...
  IF(CMAKE_COMPILER_IS_GNUCC)
    SET(COMMON_C_FLAGS               " -static-libgcc -fno-omit-frame-pointer -fno-strict-aliasing  -Wno-uninitialized")
    SET(CMAKE_C_FLAGS_DEBUG          "-O ${COMMON_C_FLAGS}")
    SET(CMAKE_C_FLAGS_RELWITHDEBINFO "-O3 ${COMMON_C_FLAGS}")
  ENDIF()
  IF(CMAKE_COMPILER_IS_GNUCXX)
    SET(COMMON_CXX_FLAGS               " -static-libgcc -fno-omit-frame-pointer -fno-strict-aliasing -Wno-uninitialized")
  ...
  IF(CMAKE_SYSTEM_NAME MATCHES "HP-UX")
	...
	# We have seen compiler bugs with optimisation and , so disabled for now
